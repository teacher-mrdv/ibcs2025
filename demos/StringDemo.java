// https://www.geeksforgeeks.org/java/substring-in-java/
...
public class StringDemo
{
	...
	public static void main (String[] args)
	{
		...
		System.out.println("\"Mathis\".compareTo(\"Marcos\"): " + "Mathis".compareTo("Marcos") );
		System.out.println("\"Marcos\".compareTo(\"Mathis\"): " + "Marcos".compareTo("Mathis") );
		System.out.println("\"Siyan\".compareToIgnoreCase(\"siyan\"): " + "Siyan".compareToIgnoreCase("siyan") );
		System.out.println("me.toUpperCase(): " + me.toUpperCase());
		System.out.println("\"seiji\".toUpperCase(): " + "seiji".toUpperCase());
		System.out.println("char[] slicedString = \"Takahito\".toCharArray(): " );
		char[] slicedString = "Takahito".toCharArray();
